...
// export function DrawPicNFT(material:Material,nftlist:Nftframe[]) {
...
function DrawPicNFT(parent:Entity,material:Material) {
...
// export function CreateNFTFrame(position:Vector3, atlasmaterial:Material,nftlink:Nftframe[]) {
export function CreateNFTFrame(pos:Vector3, rot: Quaternion, atlasmaterial:Material) {
    ...
    DrawPicNFT(simplenft, atlasmaterial);
